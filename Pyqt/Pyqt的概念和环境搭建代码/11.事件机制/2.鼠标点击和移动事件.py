...
'''
鼠标点击:Qt.MouserButton
鼠标移动: setMouseTracking(True)
...
class Widget(QWidget):
    def __init__(self):
        ...
        self.pic_lab.setPixmap(QPixmap("../11.事件机制/images/light_on.jpg").scaled(self.pic_lab.size()))
        #鼠标追踪功能
