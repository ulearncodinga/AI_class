...
if __name__ == '__main__':
    ...
    # 增加
    # my_sql.operation_sql("insert into test_info values(1, 'test11111', '123456')")
    # my_sql.operation_sql("insert into test_info values(2, 'test33333', '123456')")
    # my_sql.operation_sql("insert into test_info values(null, 'test44444', '123456')")
    #
    # my_sql.operation_sql("insert into user_info values(null, 'user11111', '123456')")
    # my_sql.operation_sql("insert into user_info values(null, 'user33333', '123456')")
    # my_sql.operation_sql("insert into user_info values(null, 'user44444', '123456')")

    # # 删除
    # my_sql.operation_sql("delete from test_info")
    # # 指定行数删除
    # my_sql.operation_sql("delete from user_info where id = 2")
